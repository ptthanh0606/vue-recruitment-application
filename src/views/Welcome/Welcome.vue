    ...
    <div class="welcome-container">
          ...
          >
            <defs>
              <linearGradient id="gradient" x1="0" x2="0" y1="0" y2="1">
                <stop offset="30%" stop-color="#E900F8" />
                <stop offset="60%" stop-color="#4BE7E4" />
              </linearGradient>
            ...
            <text y="11.5" fill="url(#wave)" fill-opacity="1">ASCEND</text>
            <text y="11.5" fill="url(#gradient)" fill-opacity="0.5">ASCEND</text>
          </svg>
          <h3
            id="slogan-alt"
            data-sal="slide-up"
        ...
        <div class="section-container">
          <div class="label-desc">
            ...
            <form
              ...
              data-sal-easing="ease-out-quint"
              data-sal-duration="2000"
              @submit="this.handleSearchByName"
            >
              <div class="typing">
                <input class="word" name="jobTitle" v-model="jobSeachValue" />
              </div>
              <button class="button-search-job" type="submit">
                <svg class="search-arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55 60">
                  <path
                    d="M36.3,12.482a2.07,2.07,0,0,0-2.724.06,1.634,1.634,0,0,0,.066,2.469l14.78,12.7H9.927a1.755,1.755,0,1,0,0,3.493H48.365L33.647,43.915a1.633,1.633,0,0,0-.066,2.469,2.07,2.07,0,0,0,2.724.059l16.81-14.511a3.266,3.266,0,0,0-.034-4.968Z"
                  />
                </svg>
              </button>
            </form>
            <h3
              ...
              data-sal-easing="ease-out-quint"
              data-sal-duration="2000"
            >Jobs have never been so easy.</h3>
          </div>
        </div>
      </section>
      <!--  -->
      <section id="thirdSection">
        <div class="section-container">
          <div class="three-dot">
            <div class="dot dot1">
              <img
                @click="() => { this.googleFlg = !this.googleFlg;
                this.appleFlg = false;
                this.colaFlg = false;
                this.nikeFlg = false;
            ...
            <div class="dot dot2">
              <img
                @click="() => { this.appleFlg = !this.appleFlg;
            ...
            <div class="dot dot3">
              <img
                @click="() => { this.colaFlg = !this.colaFlg;
                this.googleFlg = false;
                this.appleFlg = false;
                this.nikeFlg = false;
                this.paypalFlg = false;
              }"
                src="../../assets/img/coca-cola-logo.png"
                alt="Coca Cola"
              />
            </div>
            <div class="dot dot4">
              <img
                @click="() => { this.nikeFlg = !this.nikeFlg;
                this.googleFlg = false;
                this.appleFlg = false;
                this.colaFlg = false;
                this.paypalFlg = false;
              }"
                src="../../assets/img/nike-logo.png"
                alt="Nike"
              />
            </div>
            <div class="dot dot5">
              <img
                @click="() => { this.paypalFlg = !this.paypalFlg;
                this.googleFlg = false;
                this.appleFlg = false;
                this.colaFlg = false;
                this.nikeFlg = false;
              ...
              <div class="label-desc">
                ...
                >
                  ...
                  <svg
                    ...
                    width="23.279"
                    height="9.859"
                    viewBox="0 0 23.279 9.859"
                  >
                    <path
                      d="M18.026,14.1a.684.684,0,0,0-.943.991l5.272,3.063H1.824a.684.684,0,0,0,0,1.368H22.332l-5.25,3.068a.684.684,0,1,0,.943.991l5.992-3.776a1.367,1.367,0,0,0-.012-1.946Z"
                      transform="translate(-1.14 -13.915)"
                    />
                  </svg>
                </div>
              </div>
      ...
      <section id="sixthSection">
        <div class="start-button-wrapper">
          ...
          <div
            class="start-button"
            :class="{ 'rgb-animation' : btnJoinFlg }"
            @click="() => { btnJoinFlg = !btnJoinFlg }"
          >
            <div class="label">
              Start
      ...
      <footer class="footer">
        <div class="social-wrapper">
          <a href="https://www.facebook.com/" target="_blank">
            <svg id="facebook-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.661 29.321">
              <path
                data-name="Path 520"
                class="cls-1"
                d="M16.493,10.079V6.414a1.833,1.833,0,0,1,1.833-1.833h1.833V0H16.493A5.5,5.5,0,0,0,11,5.5v4.581H7.33v4.581H11V29.321h5.5V14.661h3.665l1.833-4.581Z"
          ...
          <a href="https://www.instagram.com/" target="_blank">
            ...
            >
              <path
                data-name="Path 522"
                d="M24.633,0H4.228A4.233,4.233,0,0,0,0,4.228V24.633a4.233,4.233,0,0,0,4.228,4.228H24.633a4.233,4.233,0,0,0,4.228-4.228V4.228A4.233,4.233,0,0,0,24.633,0ZM14.487,21.984a7.61,7.61,0,1,1,7.61-7.61A7.618,7.618,0,0,1,14.487,21.984ZM22.942,8.455a2.537,2.537,0,1,1,2.537-2.537A2.539,2.539,0,0,1,22.942,8.455Zm0,0"
              />
              <path
                data-name="Path 523"
                d="M392.846,90a.846.846,0,1,0,.846.846A.846.846,0,0,0,392.846,90Zm0,0"
                transform="translate(-369.904 -84.927)"
              />
              <path
                data-name="Path 524"
                d="M157.919,150a5.919,5.919,0,1,0,5.919,5.919A5.926,5.926,0,0,0,157.919,150Zm0,0"
                transform="translate(-143.432 -141.545)"
              />
            </svg>
          </a>
        ...
        <div class="copyright">© Phan Thong Thanh, Ly Phuoc Hiep - SE1304 - SWD101 Project</div>
      </footer>
    </div>
  </div>
</template>
...
import FooterFrame from '../../components/FooterFrame/FooterFrame.vue';
...
export default {
  ...
  mounted() {
    ...
    this.createIntersectObserver(
      ...
      { threshold: 0.6 },
    ).observe(document.querySelector('#firstSection'));
    ...
    this.createIntersectObserver(
      ...
      { threshold: 0.6 },
    ).observe(document.querySelector('#secondSection'));
    ...
    this.createIntersectObserver(
      ...
      { threshold: 0.6 },
    ).observe(document.querySelector('#thirdSection'));
    ...
    this.createIntersectObserver(
      ...
      { threshold: 0.6 },
    ).observe(document.querySelector('#fourthSection'));
    ...
    this.createIntersectObserver(
      ...
      { threshold: 0.6 },
    ).observe(document.querySelector('#fifthSection'));
    ...
    this.createIntersectObserver(
      ...
      { threshold: 0.6 },
    ).observe(document.querySelector('#sixthSection'));
